package com.goddoro.butcommit.service
...
import com.goddoro.butcommit.MainActivity
import com.goddoro.butcommit.R
import com.goddoro.butcommit.utils.AppPreference
import com.goddoro.butcommit.utils.CommonConst.BUT_COMMIT_FCM_TOKEN
import com.goddoro.butcommit.utils.CommonConst.UPDATE_FCM_TOKEN
    ...
    private fun updateTokenToServer(_token: String) {
        try {
            ...
            if (_token != savedFcmToken) {
                ...
                i.putExtra(BUT_COMMIT_FCM_TOKEN, _token)
                lbm.sendBroadcast(i)
            } else {
                // 서버로 token update
                val lbm = LocalBroadcastManager.getInstance(mContext!!)
